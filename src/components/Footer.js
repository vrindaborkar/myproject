        ...
        <div class="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
          <div class="lg:w-1/6 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a href="https://www.google.com"class="text-gray-600 hover:text-gray-800">First Link</a>
              </li>
              <li>
                <a href="https://www.google.com"class="text-gray-600 hover:text-gray-800">Second Link</a>
              </li>
              <li>
                <a href="https://www.google.com"class="text-gray-600 hover:text-gray-800">Third Link</a>
              </li>
              <li>
                <a href="https://www.google.com"class="text-gray-600 hover:text-gray-800">Fourth Link</a>
              </li>
            </nav>
          </div>
          <div class="lg:w-1/6 md:w-1/2 w-full px-4">
        ...
        <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
          <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            ...
            <p class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">Bitters chicharrones fanny pack
              <span class="lg:block hidden">waistcoat green juice</span>
            </p>
          </div>
      ...
      <div class="bg-gray-100">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p class="text-gray-500 text-sm text-center sm:text-left">© 2020 Tailblocks —
            <a href="https://www.google.com" class="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@knyttneve</a>
          </p>
